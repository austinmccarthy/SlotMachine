...
//  SlotMachine
//
//  Created by Austin McCarthy on 1/6/15.
...
class ViewController: UIViewController {
    ...
    func setupContainerViews()  {
        ...
        self.secondContainer = UIView(frame: CGRect(
            x: self.view.bounds.origin.x + kMarginForView, y: firstContainer.frame.height, width: self.view.bounds.width - (kMarginForView * 2), height: self.view.bounds.height * (3 * kSixth)))
...
//        var frame = CGRectInset(self.view.bounds, kMarginForView, <#dx: CGFloat#>, <#dy: CGFloat#>)
    }
